...
ob_start();
	...
	switch ($hari) {
	 ...
	 if($datapowerbank['stock'] != "0"){
	 	$query3 = "INSERT INTO peminjaman(id_user,id_powerbank,kode_booking,total_hari,total_harga,ambil) VALUES ({$datauser['id_user']},{$datapowerbank['id_powerbank']},'$kodebooking','$hari','$totalharga',0)";
